    ...
    <>
      {albums.length === 0 ? (
        <div className="form-container">
          <div className="form" style={{ padding: "1em 0", fontSize: "1rem", color: "black" }}>
            {" "}
            <label>No music has been added to this list</label>{" "}
          </div>
        </div>
      ) : (
              ...
              <>
                <div className="music-container" key={index}>
                  ...
                  <div className="music-buttons" style={{ display: "flex", alignItems: "center" }}>
                    <Link className="view-more" to={`../../album/${album._id}`}>
                      View More
                    </Link>
                    <button
                      type="button"
